  ...
  const faqs = [
    {
      ...
      answer: "고객님의 네이버 API 키는 AES-256-GCM 방식으로 암호화되어 안전하게 저장됩니다. 서버에서도 복호화된 키를 로그에 남기지 않습니다."
    },
    {
      question: "어떤 채널을 분석하나요?",
      answer: "네이버 블로그, 카페, 지식iN, 뉴스 4개 채널의 API 검색 결과와 스마트블록(플레이스, VIEW, 뉴스블록) 크롤링 결과를 통합 분석합니다."
    },
    {
      question: "SOV 분석은 어떻게 작동하나요?",
      answer: "시장 키워드 검색 결과에서 스마트블록 콘텐츠를 수집하고, OpenAI 임베딩을 활용해 브랜드 관련성을 분석하여 노출 점유율을 계산합니다."
    },
    {
      question: "무료로 사용할 수 있나요?",
      answer: "네, 기본 기능은 무료로 제공됩니다. 네이버 개발자 센터에서 발급받은 API 키만 등록하시면 바로 시작할 수 있습니다."
    }
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
                      ...
                      <CardContent className="p-3 lg:p-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="text-xs text-muted-foreground">브랜드A 점유율</div>
                          </div>
                          <div className="text-lg font-bold text-primary">42.5%</div>
                        </div>
                      </CardContent>
                    </Card>
                    <Card className="hover-lift glass-card">
                      <CardContent className="p-3 lg:p-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="text-sm font-bold text-chart-5">#1</div>
                        </div>
                      </CardContent>
                    </Card>
                  </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
              ...
              <Card className="hover-lift animate-fade-in-up-delay-2">
                <CardContent className="p-5 md:p-6 text-center">
                  ...
                  <h3 className="text-base md:text-lg font-semibold mb-2">스마트블록 크롤링</h3>
                  <p className="text-xs md:text-sm text-muted-foreground">
                    플레이스, 뉴스, VIEW 등 실시간 노출 현황 수집
                  </p>
                </CardContent>
              </Card>
              <Card className="hover-lift animate-fade-in-up-delay-3">
                <CardContent className="p-5 md:p-6 text-center">
                  ...
                  <h3 className="text-base md:text-lg font-semibold mb-2">SOV 점유율 분석</h3>
                  <p className="text-xs md:text-sm text-muted-foreground">
                    시장 키워드에서 브랜드별 노출 점유율 측정
                  </p>
                </CardContent>
              </Card>
              <Card className="hover-lift animate-fade-in-up-delay-4">
                <CardContent className="p-5 md:p-6 text-center">
                  ...
                  <h3 className="text-base md:text-lg font-semibold mb-2">분석 히스토리</h3>
                  <p className="text-xs md:text-sm text-muted-foreground">
                    SOV 분석 결과 저장 및 이전 분석 다시 보기
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        <section id="how-it-works" className="py-12 md:py-20 scroll-mt-16">
          <div className="container mx-auto px-4">
            <div className="text-center mb-8 md:mb-12 animate-fade-in">
              <h2 className="text-2xl md:text-3xl font-bold mb-3 md:mb-4">3단계로 시작하세요</h2>
              <p className="text-sm md:text-base text-muted-foreground max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-4xl mx-auto">
              <div className="relative text-center animate-fade-in-up-delay-1">
                ...
                <h3 className="text-base md:text-lg font-semibold mb-2">API 키 등록</h3>
                <p className="text-xs md:text-sm text-muted-foreground">
                  네이버 개발자 센터에서 발급받은 API 키를 등록하세요
                </p>
              </div>
              <div className="relative text-center animate-fade-in-up-delay-2">
                ...
                <div className="text-xs font-bold text-chart-2 mb-2">STEP 2</div>
                <h3 className="text-base md:text-lg font-semibold mb-2">검색 & 분석</h3>
                <p className="text-xs md:text-sm text-muted-foreground">
                  키워드를 입력하면 4채널 검색과 스마트블록 크롤링이 자동 실행됩니다
                </p>
              </div>
              <div className="relative text-center animate-fade-in-up-delay-3">
                ...
                <div className="text-xs font-bold text-chart-5 mb-2">STEP 3</div>
                <h3 className="text-base md:text-lg font-semibold mb-2">결과 확인</h3>
                <p className="text-xs md:text-sm text-muted-foreground">
                  통합 검색 결과와 SOV 점유율을 한눈에 확인하세요
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
              ...
              <div className="animate-fade-in">
                <h2 className="text-2xl md:text-3xl font-bold mb-6">안심하고 사용하세요</h2>
              ...
              <div className="animate-fade-in-up-delay-2">
                <h2 className="text-2xl md:text-3xl font-bold mb-6">자주 묻는 질문</h2>
