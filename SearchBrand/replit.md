...
### 2026-01-27 플레이스 리뷰 분석 자동 결과 표시
- 분석 작업이 완료되면 결과가 자동으로 표시됩니다
- 새 작업 생성 시 해당 작업이 자동 선택되어 진행 상황 확인 가능
- 작업 완료 시 토스트 알림 표시
- 폴링 간격 5초 → 3초로 단축하여 더 빠른 상태 업데이트

### 2026-01-27 스마트블록 PC 전용화
- 모바일 스마트블록 크롤링 기능 제거
- PC 환경(Windows Chrome, 1280x1080)만 크롤링
- 프론트엔드에서 PC/모바일 탭 및 차이점 배지 제거
